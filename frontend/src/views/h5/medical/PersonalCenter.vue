  ...
  <div class="med-personal">
    ...
    <div class="menu-list">
      <div class="menu-item" @click="navigateTo('my-appointments')">
        ...
        ><el-badge :value="2" :max="99" /><el-icon class="menu-arrow"><ArrowRight /></el-icon>
      </div>
      ...
      <div class="menu-item">
        <el-icon :color="themeColor"><Notebook /></el-icon><span>健康档案</span
        ><el-icon class="menu-arrow"><ArrowRight /></el-icon>
      </div>
    </div>
  </div>
...
<script setup>
import { Calendar, Document, FirstAidKit, Notebook, ArrowRight } from '@element-plus/icons-vue';
import { useH5Page } from '../useH5Page';
const { themeColor, adjustColor, navigateTo, setLayout } = useH5Page();
