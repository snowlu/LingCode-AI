<template>
  <div class="ecom-personal">
    ...
    >
      ...
      <div>
        <h3>张三</h3>
        <span class="user-level">钻石会员</span>
      </div>
    </div>
    ...
    <div class="menu-list">
      <div class="menu-item" @click="navigateTo('order-list')">
        ...
        ><el-badge :value="12" :max="99" /><el-icon class="menu-arrow"><ArrowRight /></el-icon>
      </div>
      <div class="menu-item" @click="navigateTo('address')">
        <el-icon :color="themeColor"><Location /></el-icon><span>收货地址</span
        ><el-badge :value="3" :max="99" /><el-icon class="menu-arrow"><ArrowRight /></el-icon>
      </div>
      <div class="menu-item" @click="navigateTo('favorites')">
        <el-icon :color="themeColor"><Star /></el-icon><span>我的收藏</span
        ><el-badge :value="28" :max="99" /><el-icon class="menu-arrow"><ArrowRight /></el-icon>
      </div>
      <div class="menu-item">
...
onMounted(async () => {
  recentOrders.value = await fetchList('orderList', { pageSize: 5 });
});
</script>
