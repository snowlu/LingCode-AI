<template>
  <div class="log-home">
    ...
    <div v-else-if="waybills.length" class="h5-list" style="padding-bottom: 80px">
      <div v-for="item in waybills" :key="item.id" class="list-card" @click="navigateTo(`track-detail/${item.id}`)">
...
const categories = [
  ...
  { name: '网点查询', icon: '📍', route: 'network-list' },
  { name: '我的寄件', icon: '📋', route: 'my-records' },
];
