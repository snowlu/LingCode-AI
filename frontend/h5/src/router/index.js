...
const routes = [
...

  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/ecommerce/Settings.vue')),
  ...
  },
  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/education/Settings.vue')),
  ...
  },
  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/government/Settings.vue')),
  ...
  },
  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/medical/Settings.vue')),
  ...
  },
  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/logistics/Settings.vue')),
    ],
  },
  {
    path: '/h5/hr',
    ...
    children: [
      ...
      h5('salary-list', () => import('@/views/h5/hr/SalaryList.vue')),
      h5('settings', () => import('@/views/h5/hr/Settings.vue')),
  ...
  },
  {
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/finance/Settings.vue')),
    ],
  },
  {
    path: '/h5/restaurant',
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/restaurant/Settings.vue')),
    ],
  },
  {
    path: '/h5/community',
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/community/Settings.vue')),
    ],
  },
  {
    path: '/h5/project',
    ...
    children: [
      ...
      h5('settings', () => import('@/views/h5/project/Settings.vue')),
    ],
  },
];
...
router.beforeEach((to, from, next) => {
  document.title = `${to.meta?.title || 'H5 移动端'} - AI 模板工厂`;
  next();
});
